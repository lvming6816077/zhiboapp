...
//    NSLog(@"%d", pageIndex);
    if (pageIndex == 3 && ![LoginUtil isLogin]) {
        [LoginUtil openLoginVC:self];
    } else {
...
-(void) publishClick {
    if (![LoginUtil isLogin]) {
        ...
        PublishViewController *pub = [[PublishViewController alloc] initWithPubType:PubTypePost andOption:nil];
