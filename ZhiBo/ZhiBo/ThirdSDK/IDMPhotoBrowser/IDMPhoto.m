...
//+ (NSArray *)photosWithPathsAndURLsMixArray:(NSArray *)mixArray
//{
//    NSMutableArray *photos = [NSMutableArray arrayWithCapacity:mixArray.count];
//    
//    for (id path in mixArray)
//    {
//        if ([path isKindOfClass:[NSString class]] && [TBUtil isLocalUrl:path])
//        {
//            IDMPhoto *photo = [IDMPhoto photoWithFilePath:path];
//            [photos addObject:photo];
//        }
...
//                IDMPhoto *photo = [IDMPhoto photoWithURL:path];
//                [photos addObject:photo];
//            }
//            else if ([path isKindOfClass:[NSString class]]) {
//                IDMPhoto *photo = [IDMPhoto photoWithURL:[NSURL URLWithString:path]];
//                [photos addObject:photo];
//            }
//        }
//    }
    ...
    if (self.underlyingImage) {
        ...
        if (_photoPath) {
            ...
            [op setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
                self.underlyingImage = [UIImage sd_animatedGIFWithData:responseObject];
                [self performSelectorOnMainThread:@selector(imageLoadingComplete) withObject:nil waitUntilDone:NO];
            } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
//                TBLogError("IDMPhoto", "图片下载失败");
            }];
...
//            self.underlyingImage = [UIImage animatedImageNamed:_photoPath duration:1];
            if (!_underlyingImage) {
